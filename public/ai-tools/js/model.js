...
const NexusModel = (() => {
  ...
  const MODEL_URL_INT8 = '/ai-tools/models/manthnet_nexus_v2_int8.onnx';
  const MODEL_URL_FP32 = '/ai-tools/models/manthnet_nexus_v2.onnx';
            ...
            externalData: [
              {
                ...
                data: '/ai-tools/models/manthnet_nexus_v2.onnx.data'
              }
            ]
          });
