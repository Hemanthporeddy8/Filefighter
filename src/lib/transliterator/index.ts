...
const langRules: Record<string, LanguageRules> = {
    ...
    bn: {
        ...
        digraphs: {},
        vowelMatras: {'a':'','aa':'া','i':'ি','ii':'ী','u':'ু','uu':'ূ','e':'ে','ee':'ো','ai':'ৈ','o':'ো','oo':'ৌ','au':'ৌ'},
    ...
    hi: {
        consonants: {'k':'क','kh':'ख','g':'ग','gh':'घ','ng':'ङ','ch':'च','chh':'छ','j':'ज','jh':'झ','ny':'ञ','t':'ट','th':'ठ','d':'ड','dh':'ढ','n':'ण','t':'त','th':'थ','d':'द','dh':'ध','n':'न','p':'प','ph':'फ','b':'ब','bh':'भ','m':'म','y':'य','r':'र','l':'ల','v':'व','s':'स','sh':'श','h':'ह'},
        digraphs: {},
    ...
    kn: {
        consonants: {'k':'ಕ','kh':'ಖ','g':'ಗ','gh':'ಘ','ng':'ಙ','ch':'ಚ','chh':'ಛ','j':'ಜ','jh':'ಝ','ny':'ಞ','t':'ಟ','th':'ಠ','d':'ಡ','dh':'ಢ','n':'ಣ','t':'ತ','th':'ಥ','d':'ದ','dh':'ಧ','n':'ನ','p':'ಪ','ph':'ಫ','b':'ಬ','bh':'ಭ','m':'మ','y':'ಯ','r':'ರ','l':'ಲ','v':'ವ','s':'ಸ','sh':'ಶ','h':'ಹ'},
        digraphs: {},
    ...
    ml: {
        consonants: {'k':'ക','kh':'ഖ','g':'ഗ','gh':'ഘ','ng':'ങ','ch':'ച','chh':'ഛ','j':'ജ','jh':'ഝ','ny':'ഞ','t':'ട','th':'ഠ','d':'ഡ','dh':'ഢ','n':'ണ','t':'ത','th':'ഥ','d':'ദ','dh':'ധ','n':'ന','p':'പ','ph':'ഫ','b':'ബ','bh':'ഭ','m':'മ','y':'യ','r':'ര','l':'ല','v':'വ','s':'സ','sh':'ഷ','h':'ഹ'},
        digraphs: {},
    ...
    mr: {
        consonants: {'k':'क','kh':'ख','g':'ग','gh':'घ','ng':'ङ','ch':'च','chh':'छ','j':'ज','jh':'झ','ny':'ञ','t':'ट','th':'ठ','d':'ड','dh':'ढ','n':'ण','t':'त','th':'थ','d':'द','dh':'ध','n':'न','p':'प','ph':'फ','b':'ब','bh':'भ','m':'म','y':'य','r':'र','l':'ल','v':'व','s':'स','sh':'ष','h':'ह'},
        digraphs: {},
        vowelMatras: {'a':'','aa':'ा','i':'ि','ii':'ी','u':'ु','uu':'ू','e':'े','ee':'े','ai':'ै','o':'ो','oo':'ौ','au':'ौ'},
        independentVowels: {'a':'अ','aa':'आ','i':'इ','ii':'ई','u':'उ','uu':'ऊ','e':'ए','ee':'ए','ai':'ऐ','o':'ओ','oo':'औ','au':'औ'},
        halant: '्',
    ...
    pa: {
        consonants: {'k':'ਕ','kh':'ਖ','g':'ਗ','gh':'ਘ','ng':'ਙ','ch':'ਚ','chh':'ਛ','j':'ਜ','jh':'ਝ','ny':'ਞ','t':'ਟ','th':'ਠ','d':'ਡ','dh':'ਢ','n':'ਣ','t':'ਤ','th':'ਥ','d':'ਦ','dh':'ਧ','n':'ਨ','p':'ਪ','ph':'ਫ','b':'ਬ','bh':'ਭ','m':'మ','y':'ਯ','r':'ਰ','l':'ਲ','v':'ਵ','s':'ਸ','sh':'ਸ਼','h':'ਹ'},
        digraphs: {},
    ...
    si: {
        consonants: {'k':'ක','kh':'ඛ','g':'ග','gh':'ඝ','ng':'ඞ','ch':'ච','chh':'ඡ','j':'ජ','jh':'ඣ','ny':'ඤ','t':'ට','th':'ඨ','d':'ඩ','dh':'ඪ','n':'ණ','t':'ත','th':'ථ','d':'ද','dh':'ධ','n':'න','p':'ප','ph':'ඵ','b':'බ','bh':'භ','m':'ම','y':'ය','r':'ර','l':'ල','v':'ව','s':'ස','sh':'ෂ','h':'හ'},
        digraphs: {},
    ...
    ur: {
        consonants: {'k':'ک','kh':'خ','g':'گ','gh':'غ','ng':'ں','ch':'چ','chh':'چھ','j':'ج','jh':'جھ','ny':'ن','t':'ٹ','th':'ٹھ','d':'ڈ','dh':'ڈھ','n':'ن','t':'ت','th':'ث','d':'د','dh':'ذ','n':'ن','p':'پ','ph':'ف','b':'ب','bh':'بھ','m':'م','y':'ی','r':'ر','l':'ل','v':'و','s':'س','sh':'ش','h':'ہ'},
        digraphs: {},
